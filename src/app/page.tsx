  ...
  loading: () => (
    <div className="flex-1 flex items-center justify-center">
      <div className="animate-pulse text-center">
        <div className="h-8 bg-orange-200 rounded mb-4 w-64"></div>
...
const FeaturedTokensCarousel = dynamic(() => import("@/components/FeaturedTokensCarousel"), {
  ssr: false,
  loading: () => (
    <div className="w-full bg-gradient-to-r from-orange-50 to-yellow-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Featured Tokens</h2>
